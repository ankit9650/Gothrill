              ...
              <div key={index} className="group" aria-label="Blog post">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <button
                    ...
                    className="text-red-500 hover:underline text-white bg-gray-800 hover:bg-gray-900 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-gray-700"
                  >
                    Delete
                  </button>
                </div>
